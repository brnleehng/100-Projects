...
* I doubt all of these will ever be completely finished.
* If you want to try your hand at these, fork this repo and **remove** my code.

Numbers
---------

[**Find PI to the Nth Digit**](https://github.com/slapvanilla/100-Projects/blob/master/Numbers/PiToTheNth.java) - Enter a number and have the program generate PI up to that many decimal places. Keep a limit to how far the program will go.
...
[**Collatz Conjecture**](https://github.com/slapvanilla/Projects/blob/master/Classic%20Algorithms/CollatzConjecture.java) - Start with a number *n > 1*. Find the number of steps it takes to reach one using the following process: If *n* is even, divide it by 2. If *n* is odd, multiply it by 3 and add 1.
